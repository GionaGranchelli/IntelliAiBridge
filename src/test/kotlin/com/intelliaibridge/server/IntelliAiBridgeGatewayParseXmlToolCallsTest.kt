...
class IntelliAiBridgeGatewayParseXmlToolCallsTest {
    ...
    fun `parseXmlToolCalls extracts tool calls and removes xml block`() {
        val input = """
            ...
            <function_calls>
              ...
              <invoke name="grep">
                <parameter name="pattern">IntelliAiBridge</parameter>
        ...
        assertEquals("IntelliAiBridge", secondJson.get("pattern").asText())
    ...
    private fun invokeParseXmlToolCalls(input: String): Any {
        val gateway = IntelliAiBridgeGateway()
